...
from Chemist_Master.views import SK_Create_Pdf,SK_View_Bills,Dashboard,DeleteProduct,EditProduct,ProductListView,order_medicine,chemist_index,chemist_signup,chemist_signin,query,Uploaded_Medi,update_med,delete_med,logout,forgot_pass,otpcheck,newpassword,order_medicine
